...
const SKILL_CRYSTALS = [
	{
		title: 'Frontend',
		desc: 'UI systems, responsive layouts, motion, and polished component work.',
		tags: ['React', 'CSS', 'Vite'],
	...
	{
		title: 'Backend',
		desc: 'APIs, data modeling, auth flows, and full-stack feature wiring.',
		tags: ['FastAPI', 'Node', 'SQL'],
		gemColor: 'rgba(205,188,255,0.92)',
		icon: '⬢',
	},
	{
		title: 'Tools',
		desc: 'Git workflows, deployment, debugging, and project delivery.',
...
export default function SkillsPage() {
	return (
		<div className="page-section">
			...
			<div className="page-crystal-row skills-page__crystals">
				{SKILL_CRYSTALS.map((item) => (
