...
const EXPERIENCE = [
  ...
  {
    title: 'AFJROTC',
    role: 'Vice Cadet Commander',
    period: 'Aug 2018 – Jun 2022',
    desc: 'Led a corps of 80+ cadets as Vice Commander. Managed scheduling, training curriculum, drill coordination, and community service initiatives.',
    accent: 'rgba(170,80,140,0.9)',
    tags: ['Leadership', 'Team Management', 'Training'],
    current: false,
  },
]
